...
//处理indent
gulp.task("indent-scss", function () {
  return gulp
    .src("stylesheet/indent.scss")
    .pipe(scss())
    .pipe(gulp.dest("dist/css"))
    .pipe(minifycss())
...
gulp.task("watch", function () {
  ...
  gulp.watch("stylesheet/indent.scss", ["indent-scss"]);
});
